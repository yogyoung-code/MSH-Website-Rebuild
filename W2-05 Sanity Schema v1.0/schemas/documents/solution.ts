...
export default defineType({
  ...
  fields: [
    ...
    // v1.0: geo direction tag for filtered case lists + copy variants
    defineField({
      name: 'geoTag',
      title: 'Geo Direction',
      type: 'string',
      group: 'content',
      options: { list: [
        { title: 'Inbound (foreign → CN)', value: 'inbound' },
        { title: 'Outbound (CN → global)', value: 'outbound' },
        { title: 'Cross-border (dual-market)', value: 'crossborder' },
      ] },
